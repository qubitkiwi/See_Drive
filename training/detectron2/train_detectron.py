...
# 학습 iter  
ITER_NUM   = 19000      
BATCH_SIZE = 20    # GPU 1대 기준 배치 사이즈   
######################################################################
...
# DATASET_NAME = f"new_parking_DT_cls{CLASS_NUM}_{IMG_SIZE}"
# DATASET_NAME = "/home/elicer/song/aihub_data_unzip"
...
DATASET_ROOT = "/home/elicer/Workspace/split_data/dataset_DT_cls29_1008x760"
# 출력 루트
OUTPUT_ROOT = "/home/elicer/sechan/trained_output/output_19000"
# 원하는 로그 경로 설정
# 1) 기본 detectron2 로거(학습 출력은 콘솔에만): 파일 로깅 없음
setup_logger()

# 2) 평가 로그만 저장할 폴더/파일
LOG_DIR = f"/home/elicer/sechan/train_log/{TRAIN_NAME}"
...
def build_cfg():
    ...
    # DataLoader
    cfg.DATALOADER.NUM_WORKERS = WORKERS_NUM
